...
zs_up = 0.06795+1E-4
zs_down = 0.04245+1E-4

tpstPosUp = 0.03509+tpst1_thick/2#0.03759+tpst1_thick/2
tpstPosDown = 0.037095412770953+tpst2_thick/2#0.03899+tpst2_thick/2
tpstPosBreak = 0.03509+tpst1_thick/2+(0.03710+tpst2_thick/2-0.03509-tpst1_thick/2)/2.52*0.875#0.040550817

mst1_up = 0.038105439604209465+mst_blade/2#0.041509243
mst1_down = 0.0402827738878873+mst_blade/2#0.04307643
mst2_up = 0.04106405266026582+mst_blade/2#0.04307643
mst2_down = 0.04324138694394365+mst_blade/2#0.045188215
mst3_up = 0.04402266571632217+mst_blade/2#0.045732813
mst3_down = 0.0462+mst_blade/2#0.0473
...
zs = lt.Septum('ZS', zs_len, zs_an, zs_up, zs_down, zs_blade,
...
tpst2 = lt.DoubleApDrift('TPST2', 2.52-0.875, tpstPosBreak, tpstPosDown,
...
drift_bump_tpst = lt.Drift('DRIFT_BUMP_TPST', 9.9525, 0)

drift_tpst_mst = lt.Drift('DRIFT_TPST_MST', 0.5575, 0)
...
beamnom = [[0.06815,-0.00139],[0.06815,-0.0015],[0.08, -0.00175], [0.083, -0.00169]]
beamdb = [[0.06815,-0.00141],[0.06815,-0.00147],[0.08, -0.00173], [0.083, -0.00170]]
